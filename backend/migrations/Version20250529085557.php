 ...
 */
final class Version20250529085557 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE refresh_token (token VARCHAR(255) NOT NULL, user_id INT NOT NULL, expires_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(token))
        SQL);
        $this->addSql(<<<'SQL'
